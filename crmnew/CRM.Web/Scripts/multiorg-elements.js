! function (e, t) {
    var i = function (t, i) {
        ...
        var o = this,
            l = e.extend({}, e.fn.ace_scroll.defaults, i);
...
function (e, t) {
    var i = function (t, i) {
        var n = e.extend({}, e.fn.ace_colorpicker.defaults, i),
            a = e(t),
            s = "",
            r = "",
            o = null,
        ...
        c = function (t) {
            ...
            return s.onload = function (s) {
                ...
                e(o).one("load", function () {
                    ...
                    var l = d(o, s, t.type);
                    if (null == l) return e(this).remove(), void a.reject({
        ...
        p = function (t, i) {
            ...
            for (var c = [], d = {}, h = 0; h < t.length; h++) {
                var p = t[h],
                    v = s ? p.name : p;
                if (!n || n.test(v))
                    if (a && a.test(v)) "ext" in d || (d.ext = []), d.ext.push(v);
                    else {
                        var g;
                        if (s) {
        ...
        return this.each(function () {
            ...
            for (var n in s)
                if (s.hasOwnProperty(n)) {
                    ...
                    if ("string" == typeof r && r in a) r = a[r], r.name = s[n];
                    else {
            ...
            t += " </div> ";
            var h;
            i.speech_button && "onwebkitspeechchange" in (h = document.createElement("input")) && (t += ' <input class="wysiwyg-speech-input" type="text" data-edit="inserttext" x-webkit-speech />'), h = null, t += " </div> ", t = i.toolbar_place ? i.toolbar_place.call(this, t) : e(this).before(t).prev(), t.find("a[title]").tooltip({
                animation: !1,
                container: "body"
