...
CKEDITOR.dialog.add( 'link', function( editor ) {
	...
	var linkTypeChanged = function() {
	    var dialog = this.getDialog(),
                partIds = ['urlOptions', 'localPageOptions', 'anchorOptions', 'emailOptions'], // edit by tuannh
	...
	return {
		...
		contents: [
			...
			elements: [
				...
				items: [
					[linkLang.toUrl, 'url'],
                    ['Claw CMS pages', 'localPage'], // edit by tuannh
                ...
                {//edit by tuannh
                    ...
                    children: [
	                {
	                    ...
	                    items: eval(document.getElementById("listInternalLinks").value),
	                    setup: function (data) {	                        
	                        if (data.localPage)
		...
		onOk: function() {
			...
			switch ( data.type || 'url' ) {
				case 'url':
					...
					break;
			    case 'localPage':	// edit by tuannh
			        attributes['data-cke-saved-href'] = data.localPage;
			        //attributes['data-cmslink'] = 'true';
			        break;
				case 'anchor':
