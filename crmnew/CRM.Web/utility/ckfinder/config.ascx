...
<script runat="server">
	...
	public override bool CheckAuthentication()
	{
        ...
        return true;// Claw.Core.ClawContext.Current.Context.Request.IsAuthenticated; 
	}
	...
	public override void SetConfig()
	{
        ...
        LicenseName = "CLAW";
        LicenseKey = "KJGW-XHXX-VXVB-6R75-AKLV-7VCW-XBB9";

		// The base URL used to reach files in CKFinder through the browser.
		//BaseUrl = Claw.Core.ClawContext.Current.CKFinderPath;
        BaseUrl = "/Claw/Data/Userfiles/";
	    ...
	    var user = ClawContext.Current.User;
        if ( user.IsAdministrator || user.IsSuperAdmin)
        {
            Session["CKFinder_UserRole"] = "Administrator";
        ...
        else
        {
            if (user.IsEditor)
            {
                Session["CKFinder_UserRole"] = "Editor";
                AccessControl acl = AccessControl.Add();
		        acl.Role = "Editor";
		        acl.ResourceType = "*";
		        acl.Folder = "/";
            ...
            else
            {
                ...
                //}
                Session["CKFinder_UserRole"] = "Register";
                AccessControl acl = AccessControl.Add();
                acl.Role = "Register";
                acl.ResourceType = "*";
                acl.Folder = "/";
        ...
        type.MaxSize = 2097152000;
		type.AllowedExtensions = new string[] { "bmp", "gif", "jpeg", "jpg", "png","zip","rar" };
		type.DeniedExtensions = new string[] { };
